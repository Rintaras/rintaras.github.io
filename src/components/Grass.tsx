...
import utility from './r3f-gist/shaders/cginc/math/utility.glsl'
import simplexNoise from './r3f-gist/shaders/cginc/noise/simplexNoise.glsl'
...
const TIP_COLOR_PRESETS = [
  '#7b8f8f', // Bright Moonlight Silver
  '#647b64', // Rich Forest
  '#6b809a', // Bright Slate
  '#a3b2b2', // Highlight Silver
]
  ...
  const [grassParams, setGrassParams] = useControls('Grass', () => ({
    ...
    Geometry: folder({
      Shape: folder({
        ...
        bladeWidthMin: { value: 0.02, min: 0.01, max: 0.2, step: 0.001 },
        bladeWidthMax: { value: 0.08, min: 0.01, max: 0.2, step: 0.001 },
